...
export const LOCALIZED_TOOL_CONTENT: Partial<Record<SupportedLanguage, Partial<Record<ToolId, LocalizedToolData>>>> = {
  ...
  ru: {
    ...
    'trim-mp4': {
      h1: 'Обрезать MP4 онлайн бесплатно без загрузки',
      subheading: 'Быстрая обрезка видео MP4 прямо в браузере. Без потери качества, водяных знаков и очередей.',
      howItWorks: [
        { step: 1, title: 'Выберите MP4 видео', description: 'Перетащите файл MP4. Видео останется только на вашем устройстве.' },
        { step: 2, title: 'Укажите время обрезки', description: 'Перемещайте ползунки шкалы времени или введите точные секунды.' },
        { step: 3, title: 'Скачайте отрезок MP4', description: 'Мгновенный экспорт без перекодирования и водяных знаков.' },
      ],
      faqs: [
        { question: 'Теряется ли качество MP4?', answer: 'Нет, инструмент вырезает кадры без сжатия, сохраняя исходное разрешение и битрейт.' },
        { question: 'Загружаются ли файлы на сервер?', answer: 'Нет, вся обработка происходит исключительно в вашем браузере.' },
      ],
    },

    'trim-mov': {
      h1: 'Обрезать MOV онлайн бесплатно без загрузки',
      subheading: 'Обрезка видео QuickTime MOV с iPhone, iPad и Mac без отправки на сервер.',
      howItWorks: [
        { step: 1, title: 'Выберите файл MOV', description: 'Загрузите запись с камеры iPhone или Mac в браузер.' },
        { step: 2, title: 'Установите метки', description: 'Настройте начало и конец фрагмента с точностью до миллисекунды.' },
        { step: 3, title: 'Сохраните клип', description: 'Скачайте готовый ролик в оригинальном качестве.' },
      ],
      faqs: [
        { question: 'Поддерживаются ли видео с iPhone?', answer: 'Да, любые записи MOV с iPhone и iPad обрабатываются мгновенно.' },
      ],
    },

    'trim-mkv': {
      h1: 'Обрезать MKV онлайн бесплатно',
      subheading: 'Точная обрезка видеофайлов MKV и записей OBS прямо в окне браузера.',
      howItWorks: [
        { step: 1, title: 'Добавьте MKV файл', description: 'Файл открывается в памяти устройства без ожидания загрузки.' },
        { step: 2, title: 'Выберите нужный момент', description: 'Используйте интерактивную шкалу времени.' },
        { step: 3, title: 'Экспортируйте видео', description: 'Скачайте готовый фрагмент без водяного знака.' },
      ],
      faqs: [
        { question: 'Можно ли обрезать стримы OBS в MKV?', answer: 'Да, файлы стримов OBS поддерживаются без необходимости конвертации.' },
      ],
    },

    'cut-mp3': {
      h1: 'Обрезать MP3 онлайн бесплатно без потери качества',
      subheading: 'Нарезка музыки MP3, создание рингтонов и удаление пауз по наглядной звуковой волне.',
      howItWorks: [
        { step: 1, title: 'Загрузите MP3 трек', description: 'Песня мгновенно декодируется в визуальную форму волны.' },
        { step: 2, title: 'Выделите фрагмент', description: 'Включите нарастание или затухание для плавного звука.' },
        { step: 3, title: 'Скачайте отрезанный MP3', description: 'Сохраните трек на компьютер или смартфон.' },
      ],
      faqs: [
        { question: 'Ухудшается ли звук при нарезке MP3?', answer: 'Нет, аудиопоток сохраняет чистый звук без повторного пережатия.' },
      ],
    },

    'cut-wav': {
      h1: 'Обрезать WAV аудио онлайн бесплатно',
      subheading: 'Профессиональная нарезка несжатого звука WAV в высоком разрешении студийного качества.',
      howItWorks: [
        { step: 1, title: 'Выберите файл WAV', description: 'Загрузите студийную запись в браузер.' },
        { step: 2, title: 'Настройте границы', description: 'Разметьте начало и конец с точностью до семпла.' },
        { step: 3, title: 'Скачайте WAV аудио', description: 'Получите чистый аудиофрагмент без компрессии.' },
      ],
      faqs: [
        { question: 'Поддерживается ли 24-битный звук?', answer: 'Да, несжатый звук WAV обрабатывается с полной точностью.' },
      ],
    },
  },
};
